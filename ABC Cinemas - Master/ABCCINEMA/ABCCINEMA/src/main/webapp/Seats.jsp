...
<body>
    ...
    <br><br><br><hr style="background-color: white;"><br><br><br>
    
    <h3 style="font-family: sans-serif; color: white; margin-right: 870px;"><center><b> Select your details </b></center></h3> <br><br><br>
