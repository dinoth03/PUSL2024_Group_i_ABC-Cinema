	  ...
	  <h2 style= "font-family: sans-serif; color: black;  margin-right: 600px;"><center><b> Payment </b></center></h2><br>
        ...
        <div class="section">
            ...
            <div class="receipt">
                ...
                <p class="total" id="total_price"><b>Total Price: 1200</b></p>
            </div>
        </div>
             ...
             <form action="CompleteBookingServlet" method="POST">
               <div class="payment-methods">
                ...
                <center><div class="card-form">
                    <input type="text" pattern="\d{16}" maxlength="16" placeholder="Card Number" required id="cd">
                    <input type="text" pattern="\d{4}" maxlength="4" placeholder="Expiration (MM/YY)" required id="ex">
                    <input type="text" pattern="\d{3}" maxlength="3" placeholder="CVV" required id="cvv">
